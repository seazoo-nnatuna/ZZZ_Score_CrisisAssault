  ...
  return (
    <div className="flex items-center justify-center gap-6 mb-6">
      <button 
        ...
        className="w-10 h-10 flex items-center justify-center rounded-full bg-[#222] border border-[#333] text-gray-400 hover:text-white hover:bg-[#333] active:scale-95 transition-all"
      >
        ◀
      </button>
